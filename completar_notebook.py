...
# Leer el notebook
with open('Tarea2Carlos_Valencia.ipynb', 'r', encoding='utf-8') as f:
    nb = json.load(f)

# ======================= ACTIVIDAD 1 =======================
# Buscar el índice después de "Respuesta 1:"
act1_idx = None
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'markdown' and 'Respuesta 1:' in ''.join(cell['source']):
        act1_idx = i + 1
        break

# Celdas de código para Actividad 1
actividad1_celdas = [
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Explicación de la Matriz CSR Generada\n",
            "\n",
...
# Insertar en orden inverso para mantener los índices
for cell in reversed(actividad1_celdas):
    nb['cells'].insert(act1_idx, cell)

# ======================= ACTIVIDAD 2 =======================
# Buscar índice después de "Respuesta 2:"
act2_idx = None
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'markdown' and 'Respuesta 2:' in ''.join(cell['source']):
        act2_idx = i + 1
        break
...
actividad2_celdas = [
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Análisis y Conclusiones - Actividad 2: Modelo ALS\n",
            "\n",
...
for cell in reversed(actividad2_celdas):
    nb['cells'].insert(act2_idx, cell)

# ======================= ACTIVIDAD 3 =======================
act3_idx = None
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'markdown' and 'Respuesta 3:' in ''.join(cell['source']):
        act3_idx = i + 1
        break
...
actividad3_celdas = [
    {
        ...
        "source": [
            ...
            "learning_rate_range = [0.001, 0.005, 0.01, 0.05, 0.1, 0.5]\n",
            "\n",
            "# K para las métricas\n",
            "k = 10\n",
            "\n",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Análisis y Conclusiones - Actividad 3: Modelo BPR\n",
            "\n",
            "#### Análisis de los Gráficos\n",
            "\n",
            "**1. Hiperparámetro: Número de Factores (Dimensiones Latentes)**\n",
...
for cell in reversed(actividad3_celdas):
    nb['cells'].insert(act3_idx, cell)

print("Notebook completado hasta Actividad 3. Continuando con Actividades 4 y 5...")

# ======================= ACTIVIDAD 4 =======================
act4_idx = None
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'markdown' and 'Respuesta 4:' in ''.join(cell['source']):
        act4_idx = i + 1
        break
...
actividad4_celdas = [
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Análisis y Conclusiones - Actividad 4: Comparación de Modelos\n",
            "\n",
...
for cell in reversed(actividad4_celdas):
    nb['cells'].insert(act4_idx, cell)

# ======================= ACTIVIDAD 5 =======================
act5_idx = None
for i, cell in enumerate(nb['cells']):
    if cell['cell_type'] == 'markdown' and 'Respuesta 5:' in ''.join(cell['source']):
        act5_idx = i + 1
        break
...
actividad5_celdas = [
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Análisis y Conclusiones - Actividad 5: Feedback Explícito vs Implícito\n",
            "\n",
...
for cell in reversed(actividad5_celdas):
    nb['cells'].insert(act5_idx, cell)

# Guardar el notebook completado
with open('Tarea2Carlos_Valencia.ipynb', 'w', encoding='utf-8') as f:
    json.dump(nb, f, ensure_ascii=False, indent=1)

print("\n" + "="*70)
print("✅ NOTEBOOK COMPLETADO EXITOSAMENTE")
print("="*70)
print("Todas las actividades (1-5) han sido agregadas al notebook:")
print("  ✓ Actividad 1: Preparación del dataset")
print("  ✓ Actividad 2: Entrenamiento ALS con análisis de hiperparámetros")
print("  ✓ Actividad 3: Entrenamiento BPR con análisis de hiperparámetros")
print("  ✓ Actividad 4: Comparación de modelos implícitos")
print("  ✓ Actividad 5: Comparación feedback explícito vs implícito")
print("\nArchivo: Tarea2Carlos_Valencia.ipynb")
print("="*70)
